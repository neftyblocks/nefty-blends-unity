...
class Wax extends universalAuthenticatorLibrary.Authenticator {
  constructor(chains, options) {
    ...
    this.freeBandwidth = options && options.freeBandwidth;
    this.feeFallback = options && options.feeFallback;
    this.verifyTx = options && options.verifyTx;
  }
  async init() {
    this.initWaxJS();
    try {
  ...
  async login() {
    ...
    try {
      ...
      throw new UALWaxError(
        ...
        universalAuthenticatorLibrary.UALErrorType.Login,
        e
      );
    }
  }
  ...
  initWaxJS() {
    this.wax = new index_js.WaxJS({
      ...
      freeBandwidth: this.freeBandwidth || false,
      feeFallback: this.feeFallback || false,
      verifyTx: this.verifyTx
    });
  }
  getEndpoint() {
